...
cap_df = cap_df.drop(columns=['IDno', 'Assessment_Date', 'Scale_BMI'])
...
# 模型保存
model_path = os.path.join(target_folder, 'cap_xgboost_model.pkl')
...
plt.tight_layout()
plt.savefig(target_folder + "cap_xgboost_plot_importance.png", dpi=300)
plt.close()
print("Saved as cap_xgboost_plot_importance.png")
