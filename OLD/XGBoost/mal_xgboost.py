...
# Load data
cap_df = pd.read_pickle(dataset_folder + 'mal_data.pkl')
...
# 模型保存
model_path = os.path.join(target_folder, 'mal_xgboost_model.pkl')
...
plt.tight_layout()
plt.savefig(target_folder + "mal_xgboost_plot_importance.png", dpi=300)
plt.close()
print("Saved as mal_xgboost_plot_importance.png")
